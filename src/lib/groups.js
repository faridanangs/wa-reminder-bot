// Mapping nama divisi -> WhatsApp Group ID (Fonnte target format: xxxxx@g.us)
export const GROUP_IDS = {
  ...
  // Humkes: "120363432331143179@g.us",
  // Perkam: "120363432331143179@g.us",
  // Konsumsi: "120363432331143179@g.us",
  // Acara: "120363432331143179@g.us",
  // PDD: "120363432331143179@g.us"
};
